...
/////////////////////////////////////////////
// prevents stack buffer overflow by not putting //
// these variables on stack /////////////////
// /////////// making it global ////////////
// if hacker wants to overflow global variable
// so what, he can't call any function. 
// its safe
...
int main(int argc, char *argv[])
{
	...
	if (send(clntSockfd, "Connected!!!\n", 
		...
		printf("Buf size %d", senderBuffSize);
